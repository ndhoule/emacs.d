...
(defvar js-doc-all-tag-alist
  '(("augments" . "Indicate this class uses another class as its \"base.\"")
    ...
    ("method" . "Provide a description of the method")
...
(defcustom js-doc-method-line" * @method %f\n"
  "method line.
 %f will be replaced with the method name"
  :group 'js-doc)
...
The comment style can be custimized via `customize-group js-doc'"
  ...
  (let ((params '())
    ...
    (save-excursion
      (cond ((looking-at "\\([a-zA-Z_][a-zA-Z0-9_]*\\) *: *function")
             (setq js-doc-current-function-name (match-string 1)))
    ...
    ;; method
    (when js-doc-current-function-name
      (add-to-list 'document-list
                   (js-doc-format-string js-doc-method-line) t))
    ;; params
    (dolist (param params)
  ...
  ;; Move forward to first line of comment, to encourage user to fill it
  (unless (looking-at "/\\*\\*")
    (search-backward "/**"))
  (forward-line)
  (end-of-line)
